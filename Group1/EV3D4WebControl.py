...
#sys.path.append("/home/robot/vscode-hello-python-master/EV3D4/ws.py")
import ws as ws


class EV3D4WebControlled(ws.WebControlledTank):

    def __init__(self, left_motor=OUTPUT_C, right_motor=OUTPUT_B):
        ws.WebControlledTank.__init__(self, left_motor, right_motor)
